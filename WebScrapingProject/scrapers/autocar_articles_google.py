...
def scrape_autocar_articles_google(tags):
    ...
    search_query = 'site:autocar.co.uk/car-news'
    for tag in tags:
    ...
    if article_urls:
        ...
        for article_url in article_urls:
            ...
            article_description = driver.find_element_by_xpath(
                '//*[@class="field field-name-field-standfirst field-type-text-long field-label-hidden"]/div/div').text
